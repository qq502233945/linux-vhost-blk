				   ...
				   struct io_comp_batch *iob, u16 idx)
{
	...
	/* normal completion path */
		...
		struct block_device *bdev = I_BDEV(req->bio->xrp_inode);
		u32 ebpf_return;
		...
		// printk("*************************\n");
		// printk("xrp_scratch_page root_pointer: %llu\n",req->bio->xrp_scratch_page.root_pointer);
		// printk("xrp_scratch_page value_ptr: %llu\n",req->bio->xrp_scratch_page.value_ptr);
		// printk("xrp_scratch_page state_flags: %u\n",req->bio->xrp_scratch_page.state_flags);
